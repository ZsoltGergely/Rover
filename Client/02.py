...
def elkuld(a):
    f=open("data.txt","w")
    f.write(str(fokba(K1.a1))+' ')
    f.write(str(fokba(K1.a2))+' ')
    f.write(str(fokba(K1.a3))+' ')
    f.write(str(fokba(K1.a4))+' ')
    f.write(str(Fog.Slider.val)+' ')
    f.close()
...
axe = plt.axes([0.05, 0.7, 0.1, 0.075])
button = Button(axe,'Submit')
...
Fog = SliderBox(0.25, 0.25,0.55,0.03, 'Grab',0,180,0,1)
